...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="ZMK Keyboard Configurator">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 text-xl font-medium">ZMK Keyboard Configurator</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                A visual tool for creating and managing your custom keyboard layouts for ZMK firmware
                            </p>
                                    ...
                                    <span>
                                        {auth.user ? (
                                            ...
                                            <Link
                                                ...
                                                className="inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                            >
                                                <span>Sign in to Create Keymaps</span>
                                                <svg
                                                    width={10}
                                                    height={11}
                                                    viewBox="0 0 10 11"
                            ...
                            <div className="absolute inset-0 flex items-center justify-center p-6">
                                <div className="text-center">
                                    <h2 className="mb-4 text-xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">
                                        ZMK Wireless Keyboard Configuration
                                    </h2>
                                    <p className="mb-3 text-[#706f6c] dark:text-[#A1A09A]">
                                        Create, configure, and customize your wireless mechanical keyboard with our visual editor
                                    </p>
                                    <div className="mt-6 grid grid-cols-3 gap-2">
                                        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((key) => (
                                            <div
                                                key={key}
                                                className="flex h-12 w-full items-center justify-center rounded border border-[#e3e3e0] bg-white shadow-sm transition-all hover:shadow dark:border-[#3E3E3A] dark:bg-[#161615]"
                                            >
                                                {key}
                                            </div>
                                        ))}
